            ...
            <div class="col-12 col-lg-4 text-center p-3">
                <div class="card">
                    ...
                    <div class="card-body font-monospace">
                        <button type="button" value="${e}" class="lootcrateCardButton btn btn-success btn-lg" data-bs-toggle="modal" data-bs-target="#lootcrateModal">${t.world.shop.unlockableCardTypes[e]}</button>
            ...
            <div class="col-12 col-lg-4 text-center p-3">
                <div class="p-2">
                    ...
                    <div class="font-monospace p-2">
                        <button type="button" value="${e}"  class="lootcrateUpgradeButton btn btn-outline-secondary pulsing-purple btn-lg" data-bs-toggle="modal" data-bs-target="#lootcrateModal">${t.world.shop.unlockableUpgrades[e]}</button>

...
class JokerCard extends TradingCard {
    ...
    constructor(name, cost, rewardAmount, valuables, colorScheme, profilePic, otherCard, triggeredByEvent, pastTenseVerb) {
        super(CardType.JOKER, null, colorScheme, cost, rewardAmount, valuables, triggeredByEvent);
        this.name = name;
        this.team = null;
        this.leagueIdNumber = -3;
        this.colorScheme = colorScheme;
        this.profilePic = profilePic;
        this.otherCard = otherCard;
        this.eventString = `${this.otherCard} Cards give +${this.rewardAmount} <span class='noto'>${this.valuables.getShadedEmoji()}</span>`;
